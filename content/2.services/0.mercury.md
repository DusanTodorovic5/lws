...
Mercury should be implemented as REST API Server, with functional requirements being:
 ...
 5. [``POST``] Request for updating account balance
 6. [``POST``] Request for updating password
...
## Request for receiving current data plan and avaliable services
...
## Request for receiving current account balance
#### url lws.com/balance
...
## Request for updating account balance
...
## Request for validating authentication header
...
## Request for receiving account statistics and usage of account's services
